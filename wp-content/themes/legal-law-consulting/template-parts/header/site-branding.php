    ...
    <div class="row">
      <div class="col-lg-4 col-md-12 col-sm-12 align-self-center">
        ...
        if($lawyer_hub_logo_settings == 'Different Line'){ ?>
          <div class="logo mb-md-2 mb-lg-2 text-center text-lg-left">
            ...
            if ( $description || is_customize_preview() ) : ?>
              <?php if(get_theme_mod('lawyer_hub_site_tagline',false) != ''){ ?>
                <p class="site-description mb-0"><?php echo esc_html($description); ?></p>
              <?php }?>
            <?php endif; ?>
          </div>
        <?php }else if($lawyer_hub_logo_settings == 'Same Line'){ ?>
          <div class="logo logo-same-line mb-md-2 mb-lg-2 text-center text-lg-left">
            <div class="row">
