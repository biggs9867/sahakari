...
<link rel="stylesheet" id="login-css" href="http://biggs9867.github.io/sahakari/wp-admin/css/login.min.css?ver=6.1.1" type="text/css" media="all">
	...
	<script type="text/javascript">document.body.className = document.body.className.replace('no-js','js');</script>
		...
		<form name="loginform" id="loginform" action="http://localhost/Sahakari/wp-login.php" method="post">
			<p>
			...
			<p class="submit">
				<input type="submit" name="wp-submit" id="wp-submit" class="button button-primary button-large" value="Log In">
									<input type="hidden" name="redirect_to" value="http://localhost/Sahakari/wp-admin/">
